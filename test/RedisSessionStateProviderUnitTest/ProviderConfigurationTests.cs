...
namespace Microsoft.Web.Redis.Tests
{
    public class ProviderConfigurationTests
    {
        ...
        public void EnableLoggingIfParametersAvailable_WrongClassName()
        {
            ...
            Exception ex = Assert.Throws<TypeLoadException>(() => ProviderConfigurationExtension.EnableLoggingIfParametersAvailable(config));
        ...
        public void EnableLoggingIfParametersAvailable_ClassNameButNotAssemblyQualified()
        {
            ...
            Exception ex = Assert.Throws<MissingMethodException>(() => ProviderConfigurationExtension.EnableLoggingIfParametersAvailable(config));
        ...
        public void EnableLoggingIfParametersAvailable_Valid()
        {
            ...
            ProviderConfigurationExtension.EnableLoggingIfParametersAvailable(config);
        }
        ...
        public void UseConnectionStringByName()
        {
            ...
            Assert.Equal(ConfigurationManager.ConnectionStrings["RedisSession"].ConnectionString,
                new SessionStateProviderConfiguration(config).ConnectionString);
        }
        ...
        public void GetConnectionString_EitherOfTwoSettings()
        {
            ...
            Exception ex = Assert.Throws<ConfigurationErrorsException>(() => ProviderConfigurationExtension.GetConnectionString(config));
            ...
            Exception ex2 = Assert.Throws<ConfigurationErrorsException>(() => ProviderConfigurationExtension.GetConnectionString(config2));
            ...
            Exception ex3 = Assert.Throws<ConfigurationErrorsException>(() => ProviderConfigurationExtension.GetConnectionString(config3));
        ...
        public void GetConnectionString_WrongClassName()
        {
            ...
            Exception ex = Assert.Throws<TypeLoadException>(() => ProviderConfigurationExtension.GetConnectionString(config));
            Assert.Contains("The specified class 'DummyClass' could not be loaded", ex.Message);
        }
        ...
        public void GetConnectionString_ClassNameButNotAssemblyQualified()
        {
            ...
            Exception ex = Assert.Throws<MissingMethodException>(() => ProviderConfigurationExtension.GetConnectionString(config));
            Assert.Contains("DummyMethodName", ex.Message);
        }
        ...
        public void GetConnectionString_Valid()
        {
            ...
            Assert.Equal("localhost:6380", ProviderConfigurationExtension.GetConnectionString(config));
        }
    }
