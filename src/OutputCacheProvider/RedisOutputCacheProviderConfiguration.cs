...
namespace Microsoft.Web.Redis
{
    internal class OutputCacheProviderConfiguration : IProviderConfiguration
    {
        ...
        internal OutputCacheProviderConfiguration()
        { }

        internal static OutputCacheProviderConfiguration ProviderConfigurationForOutputCache(NameValueCollection config)
        {
            OutputCacheProviderConfiguration configuration = new OutputCacheProviderConfiguration(config)
            {
        ...
        private OutputCacheProviderConfiguration(NameValueCollection config)
        {
